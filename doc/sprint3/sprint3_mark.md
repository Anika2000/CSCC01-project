...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1    
    Feedback: Some commit messages missing ticket number   
...
## Documentation (max 1 mark)
  ...
  Your Mark: 1 / 1   
  Feedback: Make sure you move your README file to the root
...
## Sprint Demo (Max 14 marks) 
  ...
  **- 2 marks = documentation has been created for frontend and backend systems with great detail**
  ...
  Notifications message could be clearer. Lots of space is spent on displaying time information; it would be cool if you also showed the title of the meetings.

New profile has a lot of white space, should center the information to make it look less squished

Responsive UI for landing page

For the Google Chrome extension, try and add some margins or center the elements so the text isnt' squished against the edge of the box
