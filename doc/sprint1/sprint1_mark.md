...
- (minor) "Passwords don't match"/"Please select account type" text could be a little more noticable
- Upon successful submit of profile changes, (ask again)
- Landing page could use some modification to make it look a little more alive
